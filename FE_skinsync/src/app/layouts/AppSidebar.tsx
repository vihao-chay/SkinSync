  ...
  return (
    <>
      ...
      <div className="px-4 pt-4">
        <div className="rounded-[24px] border border-border/60 bg-muted/70 px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-card text-sm font-medium text-foreground shadow-sm">
              {userName
                .split(/\s+/)
                .slice(0, 2)
                .map((part) => part[0])
      ...
      <nav className={`px-4 py-5 ${compact ? "" : "flex-1 overflow-y-auto"}`}>
