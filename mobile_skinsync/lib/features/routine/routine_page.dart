    ...
    if (regimen == null) {
      return Center(
        child: Padding(
          ...
          child: Text(
            'No routine available yet. Complete an analysis to generate one.',
              ...
              children: [
                ...
                ...reminders.map(
                  (item) => Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(item.isEnabled ? Icons.notifications_active_rounded : Icons.notifications_off_rounded, size: 18, color: AppColors.primary),
                        const SizedBox(width: 8),
                        Text('${item.routineType}: ${item.time}'),
                        const Spacer(),
                        Text(item.isEnabled ? 'On' : 'Off', style: Theme.of(context).textTheme.labelMedium),
                      ],
                    ),
                  ),
                ),
