...
namespace SkinSync.Migrations
{
    ...
    [Migration("20260812043042_AddAppInstallEvents")]
    partial class AddAppInstallEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.AppInstallEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("app_install_events", (string)null);
                });
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.PaymentOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("payment_orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_payment_orders_status", "\"Status\" IN ('pending', 'paid', 'cancelled')");
                        });
                });
