...
namespace SkinSync.Migrations
{
    ...
    [Migration("20260611110000_AddSubscriptionPlansAndQuotas")]
    partial class AddSubscriptionPlansAndQuotas
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("ai_reports", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ai_reports_report_type", "\"ReportType\" IN ('weekly', 'monthly', 'after_analysis', 'custom')");
                        });
                });
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.SkinProgressReport", b =>
                {
                    ...
                    b.ToTable("skin_progress_reports", null, t =>
                        {
                            t.HasCheckConstraint("ck_skin_progress_reports_period_type", "\"PeriodType\" IN ('weekly', 'monthly', 'yearly', 'custom')");
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.ToTable("subscription_plans", null, t =>
                        {
                            t.HasCheckConstraint("ck_subscription_plans_billing_period", "\"BillingPeriod\" IN ('none', 'monthly')");
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.SubscriptionPlanFeature", b =>
                {
                    ...
                    b.ToTable("subscription_plan_features", null, t =>
                        {
                            t.HasCheckConstraint("ck_subscription_plan_features_monthly_limit", "\"MonthlyLimit\" IS NULL OR \"MonthlyLimit\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("SkinSync.Models.Entities.UserSubscription", b =>
                {
                    ...
                    b.ToTable("user_subscriptions", null, t =>
                        {
                            t.HasCheckConstraint("ck_user_subscriptions_billing_period", "\"BillingPeriod\" IN ('none', 'monthly')");

                            t.HasCheckConstraint("ck_user_subscriptions_price_paid", "\"PricePaid\" >= 0");

                            t.HasCheckConstraint("ck_user_subscriptions_status", "\"Status\" IN ('active', 'cancelled', 'expired')");
                        });
                });
