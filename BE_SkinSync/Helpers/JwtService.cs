...
public class JwtService : IJwtAuthService
{
    ...
    public JwtService(IConfiguration configuration)
    {
        ...
        _issuer = _configuration["Jwt:Issuer"] ?? "SkinSync";
        _audience = _configuration["Jwt:Audience"] ?? "SkinSync.Client";
        _signingKey = _configuration["Jwt:SigningKey"] ?? "SkinSync.SuperSecretSigningKey.ChangeMe1234567890";
